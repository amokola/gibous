    ...
    <div className="w-full max-w-[420px] mx-auto mb-3 select-none">
      ...
      <div className="flex items-center justify-between mb-2.5 px-1">
        ...
        <button
          onClick={onBack}
          aria-label="Go back"
          className="p-2 rounded-none bg-white hover:bg-[#f2efe9] border-2 border-black text-[#1a1a1a] transition-colors sketch-shadow-xs active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-[10px] text-[#1a1a1a]/50 uppercase font-bold font-sketch">Tile</span>
